namespace ConnectFour.Shared
{
    public class GameState
    {
        ...
        {
            if (CheckForWin() != 0) throw new ArgumentException("Juego Terminado");

            // Verificar que la columna no este llena
            if (TheBoard[column] != 0) throw new ArgumentException("No puede Agregar mas fichas aqui.");

            // Empezar a posicionar la ficha
